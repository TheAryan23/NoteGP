    ...
    <Navbar/>
     <div className='flex flex-wrap justify-center items-center mt-6'>
      <div className='w-auto p-2 bg-gray-200 mt-20 rounded-lg' >
        ...
        <a href='/course/first'><div role='button'  className='bg-purple-600 my-8 rounded-xl px-20 py-2 text-white transform transition-all hover:-translate-y-2 duration-300 ' > CURRICULUM</div></a>   
