...
function Aboutus() {
  return (
   <>
      ...
      <Navbar/>
      <div className='text-2xl mb-20'>Your go-to online resource for GPM. We provide comprehensive study materials, including detailed notes, question papers, and interactive experiments to help you excel in your studies. Whether you're preparing for exams or looking to enhance your understanding of complex concepts, we've got you covered.</div>
      <div className='min-h-screen flex flex-wrap justify-center items-center'>
        <div>
        
        <div className='text-4xl mb-20'>DEVELOPED BY</div>
